...
The **target population** for this survey is **post-secondary students** (college and university learners in both STEM and non-STEM programs), as they are the group most likely to benefit from STEMBuddies’ resources. A reasonable **sampling frame** would include student mailing lists, campus newsletters, academic departments, and student organizations hosted on platforms such as Discord or Facebook. The **sample units** are **individual students**, and the survey will be distributed digitally to maximize accessibility and reach.

To implement this realistically, STEMBuddies could proceed in three steps. **First**, collaborate with universities and student associations to circulate the survey link through official mailing lists and online learning portals. **Second**, promote the survey on social media channels widely used by students, such as Instagram and Discord communities. **Third**, provide a small incentive (e.g., raffle entry or discount code) to encourage participation and reduce self-selection bias. This approach is cost-effective, scalable, and aligns with how students typically engage with online resources. The main strengths of this design are its efficiency and broad coverage, though it is still subject to **coverage bias** (students outside these networks may be missed) and **self-selection bias** (those already interested in STEM may be more likely to respond).
